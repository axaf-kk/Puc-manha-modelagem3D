...
GLfloat escala = 1.0f; // escala geral

GLfloat angulo = 0.0f; // angulo rotaçao

GLfloat transX = 0.0f; // horizontal

GLfloat transY = 0.0f; // vertical
...
// Funçao para desenhar a letra e
...
void desenhaNome() {
    float x = -4.2f, y = -0.5f; // posiçao inicial
...
void teclado(unsigned char tecla, int x, int y) {
    switch (tecla) {
        ...
        case '-':
            ...
            break;
        case 'q': // rotaçao anti-horario
            angulo += 5.0f;
            break;
        case 'e': // rotaçao horario
            angulo -= 5.0f;
            break;
        case 'a': // esquerda
            transX -= 0.5f;
